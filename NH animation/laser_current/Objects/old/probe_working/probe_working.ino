...
//probe front y coordinate variables
int Pya=30;
int Pyb=30;
int Pyc=80;
int Pyd=80;
...
line(Px1ar,Py1a,Px2r,Py1b);//top line - go clockwise from here//HORIZONTAL
line(Px2r,Py1b,Px3r,Py1c);//left upright on RTG//VERTICAL
line(Px3r,Py1c,Px4r,Py1d);//HORIZONTAL
line(Px4r,Py1d,Px5ar,Py1e);//VERTICAL
line(Px5r,Py1e,Px6r,Py1f);//INCLINED
line(Px6r,Py1f,Px7r,Py1g);//VERTICAL
line(Px7r,Py1g,Px8r,Py1h);//bottom line//HORIZONTAL
line(Px8r,Py1h,Px9r,Py1i);//VERTICAL
line(Px9r,Py1i,Px1ar,Py1a);//INCLINED
